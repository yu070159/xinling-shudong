      ...
      '<div class="admin-panel">' +
        '<div class="admin-panel-header">' +
          '<div style="display:flex;align-items:center;gap:12px;">' +
            '<h2 class="admin-panel-title" style="margin:0;">🛡️ 管理员面板</h2>' +
            '<a href="admin-dashboard.html" style="font-size:12px;color:var(--accent);text-decoration:none;padding:2px 8px;border:1px solid var(--accent);border-radius:8px;" title="打开完整仪表盘">📊 仪表盘</a>' +
          '</div>' +
